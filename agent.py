...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1, alpha=0.05):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing is True:
            ...
            #self.epsilon = math.cos(self.epsilon*self.counter)
            self.epsilon = math.exp(-.01*self.counter)
            #self.epsilon = 1.0/(self.counter)**2
            #self.epsilon=(self.epsilon)**(self.counter)
            self.counter += 1
